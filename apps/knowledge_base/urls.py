...
urlpatterns = [
    ...
    path('<int:pk>/edit/', views.article_edit_content, name='edit_content'),
    path('images/upload/', views.kb_image_upload, name='image_upload'),
    path('<int:pk>/metadata/', views.article_metadata_update, name='metadata_update'),
